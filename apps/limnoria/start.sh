# ===== From ./processed/limnoria/root/etc/s6-overlay//s6-rc.d/init-limnoria-config/run =====
...
# ===== From ./processed/limnoria/root/etc/s6-overlay//s6-rc.d/init-limnoria-plugin-requirements/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/limnoria/root/etc/s6-overlay//s6-rc.d/svc-limnoria/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
