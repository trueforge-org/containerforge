# ===== From ./processed/healthchecks/root/etc/s6-overlay//s6-rc.d/init-healthchecks-config/run =====
...
# ===== From ./processed/healthchecks/root/etc/s6-overlay//s6-rc.d/svc-healthchecks/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
