# ===== From ./processed/rsnapshot/root/etc/s6-overlay//s6-rc.d/init-rsnapshot-config/run =====
...
# ===== From ./processed/rsnapshot/root/etc/s6-overlay//s6-rc.d/init-rsnapshot-test/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/rsnapshot/root/etc/s6-overlay//s6-rc.d/init-rsnapshot-upgrade/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
