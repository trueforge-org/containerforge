# ===== From ./processed/wireguard/root/etc/s6-overlay//s6-rc.d/init-wireguard-confs/run =====
...
# ===== From ./processed/wireguard/root/etc/s6-overlay//s6-rc.d/init-wireguard-module/run =====
#!/usr/bin/with-contenv bash
...
# ===== From ./processed/wireguard/root/etc/s6-overlay//s6-rc.d/svc-coredns/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/wireguard/root/etc/s6-overlay//s6-rc.d/svc-wireguard/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
