...
- Command: `docker build --progress=plain --platform linux/amd64 -t porting-ngircd:amd64 .`
- Result: FAIL
- Reason: 3.747 E: Unable to locate package ngircd-doc=
