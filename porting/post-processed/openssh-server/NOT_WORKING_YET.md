...
- Command: `docker build --progress=plain --platform linux/amd64 -t porting-openssh-server:amd64 .`
- Result: FAIL
- Reason: 6.526 E: Unable to locate package openssh-sftp-server=
