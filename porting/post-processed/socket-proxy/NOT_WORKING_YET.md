...
- Command: `docker build --progress=plain --platform linux/amd64 -t porting-socket-proxy:amd64 .`
- Result: FAIL
- Reason: 5.773 E: Unable to locate package haproxy=
