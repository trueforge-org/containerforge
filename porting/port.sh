...
BLACKLIST=("nextcloud" "ci" "build-agent" "jenkins-builder" "d2-builder" "documentation" "fleet" "homeassistant" "hubstats" "lsio-api" "manifest-tool" "modmanager" "selkies" "swag" "gc")
