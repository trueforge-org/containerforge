...
- Command: `docker build --progress=plain --platform linux/amd64 -t porting-xbackbone:amd64 .`
- Result: FAIL
- Reason: 4.621 E: Unable to locate package php84-tokenizer
