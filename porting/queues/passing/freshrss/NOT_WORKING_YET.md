...
- Command: `docker build --progress=plain --platform linux/amd64 -t porting-freshrss:amd64 .`
- Result: FAIL
- Reason: 13.03 sed: can't read /etc/php/8.3/fpm/pool.d/www.conf: No such file or directory
