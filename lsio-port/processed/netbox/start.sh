# ===== From ./processed/netbox/root/etc/s6-overlay//s6-rc.d/init-netbox-config/run =====
...
# ===== From ./processed/netbox/root/etc/s6-overlay//s6-rc.d/svc-netbox/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/netbox/root/etc/s6-overlay//s6-rc.d/svc-netbox-prepare/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
