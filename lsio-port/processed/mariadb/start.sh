# ===== From ./processed/mariadb/root/etc/s6-overlay//s6-rc.d/init-mariadb-config/run =====
...
# ===== From ./processed/mariadb/root/etc/s6-overlay//s6-rc.d/init-mariadb-initdb/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/mariadb/root/etc/s6-overlay//s6-rc.d/init-mariadb-poststart/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
...
# ===== From ./processed/mariadb/root/etc/s6-overlay//s6-rc.d/svc-mariadb/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
