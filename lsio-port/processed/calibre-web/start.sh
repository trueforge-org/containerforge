# ===== From ./processed/calibre-web/root/etc/s6-overlay//s6-rc.d/init-calibre-web-config/run =====
...
# ===== From ./processed/calibre-web/root/etc/s6-overlay//s6-rc.d/svc-calibre-web/run =====
#!/usr/bin/with-contenv bash
# shellcheck shell=bash
